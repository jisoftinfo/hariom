...
Public Class cryCompanyInfo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "JISPOS.cryCompanyInfo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryCompanyInfo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryCompanyInfo = New cryCompanyInfo
        rpt.Site = Me.Site
        Return rpt
    End Function
