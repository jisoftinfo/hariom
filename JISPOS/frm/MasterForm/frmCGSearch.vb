Public Class frmCGSearch
    ...
    Sub ViewSearch()
        ...
        dgvUOM.DataSource = db.CountGroup.Grid("CountGroupCode,CountGroupName", WQry)
        dgvUOM.Width = 410
        dgvUOM.Columns("CountGroupCode").Width = 200
        dgvUOM.Columns("CountGroupName").Width = 200

        dgvUOM.Columns("CountGroupCode").HeaderText = "CODE"
        dgvUOM.Columns("CountGroupName").HeaderText = "COUNT GROUP"
    End Sub
    ...
    Private Sub cmbCustomerName_Enter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtCountGroup.Enter
        sender.Backcolor = FColor
        sender.Forecolor = BColor
        If sender.Name.ToLower.StartsWith("cmb") Then sender.Height = cmbEnterHeight
    End Sub

    Private Sub CTRL_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtCountGroup.Leave
    ...
    Private Sub dgvCustomerSearch_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgvUOM.DoubleClick
        Try
            frmCountGroup.txtSearchBox.Text = dgvUOM.SelectedRows(0).Cells(0).Value()
            frmCountGroup.ViewForm()
