Public Class frmCNoReport
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        DTProducts = db.EForm.Grid("*", WQry).ToTable("EForm")
    ...
    End Sub
    Private Sub txtCode_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbMillName.Enter, txtCFormNo.Enter, cmbYear.Enter, cmbPeriodFrom.Enter
    ...
    Private Sub txtcode_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbMillName.Leave, txtCFormNo.Leave, cmbYear.Leave, cmbPeriodFrom.Leave
