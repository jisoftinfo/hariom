...
Public Class frmSupplierSearch
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        dgvCustomerSearch.Columns("ShortName").Width = 200
        dgvCustomerSearch.Columns("DueDays").Width = 150
        dgvCustomerSearch.Columns("EMailId").Width = 250
        dgvCustomerSearch.Columns("Person").Width = 250
        dgvCustomerSearch.Columns("ContactNo").Width = 250
        dgvCustomerSearch.Columns("Department").Width = 250
        dgvCustomerSearch.Columns("Designation").Width = 250
        dgvCustomerSearch.AllowUserToResizeRows = True
        dgvCustomerSearch.AllowUserToResizeColumns = True

        dgvCustomerSearch.Columns("MillCode").Visible = False
    End Sub
    ...
    Sub ViewSearch()
        ...
        DV = db.Mill.Grid("MillCode,MillName,AddressLine1,ShortName,DueDays,EMailId,CountGroup,Person1,PMobile1,Person2,PMobile2,Person3,PMobile3,Person4,PMobile4,Department1,Designation1,Department2,Designation2,Department3,Designation3,Department4,Designation4", WQry)
        ...
        For i As Integer = 0 To DV.Count - 1
            ...
            dgvCustomerSearch.Item("MillCode", i).Value = DV.Item(i)("MillCode").ToString()
            ...
            dgvCustomerSearch.Item("DueDays", i).Value = DV.Item(i)("DueDays").ToString()
            dgvCustomerSearch.Item("EMailId", i).Value = DV.Item(i)("EMailId").ToString()
            dgvCustomerSearch.Item("CountGroup", i).Value = DV.Item(i)("CountGroup").ToString()
    ...
    Private Sub cmbCustomerName_Enter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtAddress.Enter, txtMobile.Enter, txtMailId.Enter, txtAddress2.Enter, cmbCustomerName.Enter, cmbCountGroup.Enter
    ...
    Private Sub CTRL_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtAddress.Leave, txtMobile.Leave, txtMailId.Leave, txtAddress2.Leave, cmbCustomerName.Leave, cmbCountGroup.Leave
