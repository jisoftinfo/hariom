Public Class frmUnits
    ...
    Dim tb As JISTable = db.UnitsOfMeasurement

    Function FormValidate() As Boolean
        Dim RValue As Boolean = True
        If txtSymbol.Text.Trim() = "" Then
            ErrorProvider1.SetError(txtSymbol, "Please Enter the Symbol")
            txtSymbol.Focus()
            RValue = False
        ElseIf tb.State = "New" And tb.ExistUserCode(txtSymbol.Text) Then
            ErrorProvider1.SetError(txtSymbol, txtSymbol.Text + " is Already Exist. Please Enter the New Symbol")
            txtSymbol.Focus()
            RValue = False
        Else
    ...
    Private Sub CTRL_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtCode.Enter, txtSymbol.Enter, txtFormalName.Enter
    ...
    Private Sub CTRL_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtCode.Leave, txtSymbol.Leave, txtFormalName.Leave
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        tb.SetControls(txtId, txtCode, txtSymbol, txtFormalName)
        SetFormStyle(Me)
        NewForm()
    End Sub
    ...
    Private Sub btnSearch1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch1.Click
        FormShow(frmUnitsOfMeasurementSearch)
    End Sub
End Class