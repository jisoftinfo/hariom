Public Class frmUnitsReport
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        DTUnits = db.UnitsOfMeasurement.Grid("*", WQry).ToTable("UnitsOfMeasurement")

        ds.Clear()
        ds.Tables.Add(DTCompanyDetails)
        ds.Tables.Add(DTUnits)
        ReportView(CrystalReportViewer1, "Master\cryUnits.rpt", ds)
    End Sub

    Private Sub btnExit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExit.Click
        SendKeys.Send("{ESCAPE}")
    End Sub
    Private Sub txtCode_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtGroupName.Enter, txtUnder.Enter
    ...
    Private Sub txtcode_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtGroupName.Leave, txtUnder.Leave
