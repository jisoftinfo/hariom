Public Class frmTextTranslation

    Dim tb As JISTable = db.TextTranslation

    Function FormValidate() As Boolean
        Dim RValue As Boolean = True
        If txtEnglish.Text.Trim() = "" Then
            ErrorProvider1.SetError(txtEnglish, "Please Enter the English")
            txtEnglish.Focus()
            RValue = False
        ElseIf tb.State = "New" And tb.ExistUserCode(txtEnglish.Text) Then
            ErrorProvider1.SetError(txtEnglish, txtEnglish.Text + " is Already Exist. Please Enter the New English")
            txtEnglish.Focus()
            RValue = False
        Else
            ErrorProvider1.SetError(txtEnglish, "")
        End If
        Return RValue
    End Function

    Private Sub CTRL_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtCode.Enter, txtEnglish.Enter, txtTamil.Enter, txtSearchBox.Enter
    ...
    Private Sub CTRL_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtCode.Leave, txtEnglish.Leave, txtTamil.Leave, txtSearchBox.Leave
    ...
    Private Sub frm_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        tb.SetControls(txtId, txtCode, txtEnglish, txtTamil, txtHindhi, txtMalayalam, txtTelugu)
        SetFormStyle(Me)
        NewForm()
    End Sub

    Private Sub btnView_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnView.Click
        FormShow(frmTextTranslationReport)
    End Sub
