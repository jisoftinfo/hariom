Public Class frmAutoEmailPendingSerach
    ...
    Sub ViewSearch()
        ...
        dgvUOM.DataSource = db.AutoEMailPending.Grid("ECode,Subject,Message")
    ...
    Private Sub dgvCustomerSearch_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgvUOM.DoubleClick
        Try
            frmAutoEMailPending.txtSearchBox.Text = dgvUOM.SelectedRows(0).Cells(0).Value()
            frmAutoEMailPending.ViewForm()
