Public Class frmAutoEmailReport
    Dim db As New DBLib
    ...
    Sub ViewSearch()
        ...
        DTUnits = db.AutoEMailPending.Grid("*", WQry).ToTable("AutoEMailPending")

        ds.Clear()
        ds.Tables.Add(DTCompanyDetails)
        ds.Tables.Add(DTUnits)
        ReportView(CrystalReportViewer1, "Master\cryAutoEmailPending.rpt", ds)
    End Sub
    Private Sub btnExit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExit.Click
        SendKeys.Send("{ESCAPE}")
    End Sub
    Private Sub txtCode_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtEmailId.Enter
    ...
    Private Sub txtcode_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtEmailId.Leave
