Public Class frmDebitSearch
    ...
    Sub ViewSearch()
        ...
        Dim dv As DataView
        dv = db.Payment.Grid("PaymentCode as 'Code', PaymentDate as 'Date', PaymentTo, PayName, PaymentFrom as 'Mode',PayAmount", WQry, "PaymentCode")

        dgvSearch.DataSource = dv
        dgvSearch.Columns("Code").Width = 100
        dgvSearch.Columns("Date").Width = 120
        dgvSearch.Columns("PaymentTo").Width = 150
        dgvSearch.Columns("PayName").Width = 170
        dgvSearch.Columns("Mode").Width = 120
        dgvSearch.Columns("PayAmount").Width = 130
    ...
    End Sub
    Private Sub btnExit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExit.Enter
    ...
    Private Sub cmbPayCode_Enter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtBillAmountTo.Enter, txtBillAmountFrom.Enter, cmbPayName.Enter, cmbPayMode.Enter, cmbPaymentTo.Enter, cmbPayCode.Enter
        sender.Backcolor = FColor
        sender.Forecolor = BColor
        If sender.Name = cmbPayCode.Name Then List_Datas(cmbPayCode, db.Payment.Codes())
    ...
    Private Sub cmbPayCode_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtBillAmountTo.Leave, txtBillAmountFrom.Leave, cmbPayName.Leave, cmbPayMode.Leave, cmbPaymentTo.Leave, cmbPayCode.Leave
