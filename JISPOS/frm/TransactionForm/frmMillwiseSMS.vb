            ...
            For i As Integer = 0 To dgvCustomerSearch.SelectedRows.Count - 1
                ...
                If PhNo <> "" Then
                    ...
                    For j As Integer = 0 To arr.Count - 1
                        db.SMSSending.SaveRecord(db.SMSSending.NewId(), db.SMSSending.NewCode(), arr(j), txtMsg.Text, Now.ToString(), "UnSent", dgvCustomerSearch.Item("RName", i).Value.ToString())
                    Next
