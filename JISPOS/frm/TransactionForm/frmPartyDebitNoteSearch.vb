...
Public Class frmPartyDebitNoteSearch
    ...
    Sub ViewSearch()
        ...
        End If
        frmDebitTransaction.Arr_SearchCodes = db.ViewDebitNoteParty.Column("DNCode", WQry)
        dgvDebitNoteMill.DataSource = db.ViewDebitNoteParty.Grid("DNCode, CompanyName, MillName as PartyName, BillDate, FORMAT(PeridFrom, 'dd/MM/yyyy') + ' - ' + format(PeriodTo, 'dd/MM/yyyy') AS Period, iif(type='Amount' or type ='ExMillAmount',format(CommissionPer,'0.00')+'%',iif(type='Kg', Format(CommissionPer,'0.00/Kg'),Format(CommissionPer,'0/Bag'))) as CommissionPer, NoOfBags, TotalKg, Amount, ExMillAmount, CommissionAmt, TaxAmount, TotalAmount", WQry)
        dgvDebitNoteMill.Columns("DNCode").Width = 70
        dgvDebitNoteMill.Columns("CompanyName").Width = 200
        dgvDebitNoteMill.Columns("PartyName").Width = 300
        ...
        dgvDebitNoteMill.Columns("PartyName").HeaderText = "PARTY NAME"
    ...
    Private Sub dgvCustomerSearch_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgvDebitNoteMill.DoubleClick
        Try
            frmPartyDebitNote.txtSearchBox.Text = dgvDebitNoteMill.SelectedRows(0).Cells(0).Value()
            frmPartyDebitNote.SearchCodeIndex = dgvDebitNoteMill.SelectedRows(0).Index
            frmPartyDebitNote.btnSearch1_Click(sender, e)
    ...
    Private Sub rbnInfixCustomer_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rbnInfixMill.CheckedChanged
    ...
    Private Sub btnBill_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBill.Click
        Try
            ...
            f.ViewPrint(frmPartyDebitNote.txtCode.Text)
    ...
    Private Sub cmbMillName_KeyUp(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cmbMillName.KeyUp, cmbCompany.KeyUp
        If sender.Name = cmbMillName.Name Then
            List_Datas(cmbMillName, db.Party.Column("PartyName", "PartyName like '%" + sender.Text + "%'"))
        End If
