Public Class frmScheduledEmailReport
    Dim db As New DBLib
    ...
    Sub ViewSearch()
        ...
        DTUnits = db.EMailSending.Grid("*", WQry).ToTable("EMailSending")

        ds.Clear()
        ds.Tables.Add(DTCompanyDetails)
        ds.Tables.Add(DTUnits)
        ReportView(CrystalReportViewer1, "Master\cryScheduledEmail.rpt", ds)
    End Sub
